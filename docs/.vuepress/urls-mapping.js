module.exports = {
  ...
  "/how_to's/": "/how_to/",
  "/how_to's/#how-to-disable-hyperthreading-smt-without-reboot-kernelcare-case": "/how_to/#how-to-disable-hyperthreading-smt-without-reboot-kernelcare-case",
  "/how_to's/#smt-control": "/how_to/#smt-control",
  "/how_to's/#smt-status": "/how_to/#smt-status",
  "/how_to's/#check-the-smt-state": "/how_to/#check-the-smt-state",
  "/how_to's/#enable-smt": "/how_to/#enable-smt",
  "/how_to's/#disable-smt": "/how_to/#disable-smt",
  "/how_to's/#example": "/how_to/#example",
  "/how_to's/#how-to-update-microcode-without-reboot-with-vendor-provided-package": "/how_to/#how-to-update-microcode-without-reboot-with-vendor-provided-package",
  "/how_to's/#updating-microcode-on-ubuntu-and-debian": "/how_to/#updating-microcode-on-ubuntu-and-debian",
  "/how_to's/#updating-microcode-on-red-hat-and-centos": "/how_to/#updating-microcode-on-red-hat-and-centos",
  "/how_to's/#updating-microcode-on-centos-6": "/how_to/#updating-microcode-on-centos-6",
  "/how_to's/#plesk-related": "/how_to/#plesk-related",
  "/how_to's/#how-to-get-a-kernelcare-activation-key-from-the-extended-plesk-license": "/how_to/#how-to-get-a-kernelcare-activation-key-from-the-extended-plesk-license",
  "/jp/how_to's/": "/jp/how_to/",
  "/jp/how_to's/#再起動せずにハイパースレッディング（smt）を無効にする方法-kernelcare-case": "/jp/how_to/#再起動せずにハイパースレッディング（smt）を無効にする方法-kernelcare-case",
  "/jp/how_to's/#smt-のコントロール": "/jp/how_to/#smt-のコントロール",
  "/jp/how_to's/#smt-ステータス": "/jp/how_to/#smt-ステータス",
  "/jp/how_to's/#smt-の状態を確認": "/jp/how_to/#smt-の状態を確認",
  "/jp/how_to's/#smt-を有効に": "/jp/how_to/#smt-を有効に",
  "/jp/how_to's/#smt-を無効に": "/jp/how_to/#smt-を無効に",
  "/jp/how_to's/#例": "/jp/how_to/#例",
  "/jp/how_to's/#ベンダ提供のパッケージで再起動せずにマイクロコードを更新する方法": "/jp/how_to/#ベンダ提供のパッケージで再起動せずにマイクロコードを更新する方法",
  "/jp/how_to's/#ubuntuとdebianでのマイクロコード更新": "/jp/how_to/#ubuntuとdebianでのマイクロコード更新",
  "/jp/how_to's/#red-hatおよびcentosでのマイクロコード更新": "/jp/how_to/#red-hatおよびcentosでのマイクロコード更新",
  "/jp/how_to's/#centos-6でのマイクロコードの更新": "/jp/how_to/#centos-6でのマイクロコードの更新"
};
