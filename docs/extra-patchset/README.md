...
KernelCare Extra patchset includes all the security fixes from KernelCare for AlmaLinux, CentOS 6, CentOS 7, and CentOS 8 as well as symlink protection and IPSet bugfix for CentOS 6.
