...
:::tip Note
BETA version of KernelCare package with KC+ functionality available [here](http://patches04.kernelcare.com/userspace/kernelcare-2.32-1.el7.1595920539.56067.28.x86_64.rpm).
:::
